      ...
      <div className="flex flex-col min-h-screen">
        <main className="flex-grow flex flex-col items-center justify-center text-white">
          ...
          <div className="text-center mt-3 bg-gradient-to-r from-purple-400 via-pink-500 to-orange-500 bg-clip-text text-transparent text-2xl font-bold">
            ...
            <p
              className="mt-2 text-xl font-mono text-black
          "
            >
            ...
            <button
              ...
              className="mt-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-orange-500 text-white font-semibold rounded-full shadow-lg hover:scale-105 transition"
            >
              Get Started
            </button>
          </div>
              ...
              <div className="container  mx-auto flex flex-col lg:flex-row items-center justify-between">
                ...
                <div className="max-w-lg text-white">
                  <h1 className="text-4xl md:text-6xl font-bold">
                    Track Your <span className="text-yellow-400">Progress</span>{" "}
                    Daily!
                  </h1>
                  <p className="mt-4 text-xl opacity-80">
                    Stay motivated and challenge yourself with our daily
                    leaderboard. Compete with your friends and push your limits!
                  </p>
                  <button onClick={() => navigate("/workout")}  className="mt-6 px-6 py-3 bg-gradient-to-r from-purple-500 to-orange-500 text-white font-semibold rounded-full shadow-lg hover:scale-105 transition">
          ...
          <div className="relative w-full">
            ...
            <div className="relative text-center p-10 z-10">
              <h2 className="text-3xl font-bold text-black">
                LOGIN <span className="text-purple-600">TO SAVE</span> YOUR
                WORKOUT RECORD
              </h2>
              <p className="mt-4 text-lg text-gray-700">
                You can save your workout reps and compete in the daily
                leaderboard.
              </p>
            </div>
          </div>
            ...
            <section className="relative w-full flex items-center justify-center bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600 py-10 lg:py-12">
              <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between  lg:h-auto">
                ...
                <div className="max-w-lg text-white text-center lg:text-left lg:ml-10">
                  <h1 className="text-4xl md:text-6xl font-bold">
                    Understand Your{" "}
                    <span className="text-yellow-400">Body</span> Better!
                  </h1>
                  <p className="mt-4 text-amber-50  opacity-90">
                    Calculate your BMI to monitor your health and maintain a
                    balanced lifestyle. Stay within a healthy range and take
                    charge of your fitness goals.
                  </p>
